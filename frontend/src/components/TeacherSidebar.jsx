...
export default memo(function TeacherSidebar() {
  ...
  const navItems = useMemo(() => [
    {
      ...
      links: [
        { to: '/teacher', label: t('sidebar.dashboard'), icon: '📊', end: true },
      ],
    },
    {
      section: t('sidebar.teaching'),
      links: [
        { to: '/teacher/classes', label: t('sidebar.myClasses'), icon: '🏫' },
        { to: '/teacher/schedule', label: t('sidebar.mySchedule'), icon: '🗓️' },
      ],
    },
    {
      section: t('sidebar.communication'),
      links: [
        { to: '/teacher/announcements', label: t('sidebar.announcements'), icon: '📢' },
      ],
    },
  ], [t]);
    ...
    <>
      ...
      <div className="sidebar-header">
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem' }}>
          ...
          <div>
            <h2>EduSys</h2>
            <span>{t('sidebar.teacherPortal')}</span>
          </div>
        </div>
      </div>
      ...
      <div className="sidebar-footer">
        <div className="sidebar-user">
          ...
          <div className="sidebar-user-info">
            ...
            <div className="sidebar-user-role">{t('roles.teacher')}</div>
          </div>
        </div>
